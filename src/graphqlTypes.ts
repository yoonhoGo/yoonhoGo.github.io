...
export type GitHub_ProjectTeamEdge = {
  ...
  projectTeamResourcePath: Scalars['GitHub_URI'],
  /** The HTTP URL for this project's team */
  projectTeamUrl: Scalars['GitHub_URI'],
};
...
export type GitHub_TeamProjectEdge = {
  ...
  inheritedPermissionOrigin?: Maybe<GitHub_Team>,
  /** The item at the end of the edge. */
  node?: Maybe<GitHub_Project>,
  /** The HTTP path for this team's project */
  teamProjectResourcePath: Scalars['GitHub_URI'],
  /** The HTTP URL for this team's project */
  teamProjectUrl: Scalars['GitHub_URI'],
};
...
export type SmallAboutComponentQuery = (
  { __typename?: 'Query' }
  & { site: Maybe<(
    { __typename?: 'Site' }
    & { siteMetadata: Maybe<(
...
export type AboutComponentQueryVariables = {};


export type AboutComponentQuery = (
  { __typename?: 'Query' }
  & { site: Maybe<(
    { __typename?: 'Site' }
    & { siteMetadata: Maybe<(
...
export type SeoQuery = (
  ...
  & { site: Maybe<(
    ...
    & { siteMetadata: Maybe<(
      { __typename?: 'SiteSiteMetadata' }
      & Pick<SiteSiteMetadata, 'title' | 'siteUrl' | 'description' | 'defaultImage' | 'bio' | 'author'>
      & { socialUsernames: Maybe<(
        { __typename?: 'SiteSiteMetadataSocialUsernames' }
        & Pick<SiteSiteMetadataSocialUsernames, 'twitter' | 'instagram' | 'github' | 'email'>
      )> }
    )> }
  )> }
);
...
export type Unnamed_1_Query = (
  ...
  & { site: Maybe<(
    ...
    & { siteMetadata: Maybe<(
      { __typename?: 'SiteSiteMetadata' }
      & Pick<SiteSiteMetadata, 'author' | 'bio' | 'defaultImage' | 'description' | 'siteUrl' | 'title'>
      & { socialUsernames: Maybe<(
        { __typename?: 'SiteSiteMetadataSocialUsernames' }
        & Pick<SiteSiteMetadataSocialUsernames, 'email' | 'github' | 'instagram' | 'twitter'>
      )> }
    )> }
  )> }
);
